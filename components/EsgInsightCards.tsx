      ...
      <div className="card-hover border-l-4 border-l-forest-500">
        ...
        {rationale.error && (
          <p className="text-sm text-red-600">
            {rationale.error}. Set <code className="rounded bg-slate-100 px-1">GEMINI_API_KEY</code> in
              ...
              <div key={ticker} className="card-hover">
                ...
                {entry?.error && (
                  <p className="text-xs text-red-600">
                    {entry.error}. Set <code className="rounded bg-slate-100 px-1">GEMINI_API_KEY</code>{" "}
